...
<p class="has-text-align-left has-small-font-size"><?php esc_html_e( 'Fresh Designs of Our Spring Collection.', 'the8-shop-dark' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'New Arrivals', 'the8-shop-dark' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Shop Now', 'the8-shop-dark' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
...
<div class="wp-block-group" style="padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:paragraph {"align":"left","placeholder":"Write title…","fontSize":"small"} -->
<p class="has-text-align-left has-small-font-size"><?php esc_html_e( 'Comfort With Our latest Footwear Collection.', 'the8-shop-dark' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Footwear', 'the8-shop-dark' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group" style="padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:paragraph {"align":"left","placeholder":"Write title…","fontSize":"small"} -->
<p class="has-text-align-left has-small-font-size"><?php esc_html_e( 'Exclusive Selection of Imported', 'the8-shop-dark' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Perfumes', 'the8-shop-dark' ); ?></h2>
<!-- /wp:heading -->
