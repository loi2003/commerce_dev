 ...
 *
 * Passes it through the `the8_shop_dark_get_starter_content` filter before returning.
 *
...
function the8_shop_dark_get_starter_content() {
	...
	$starter_content = array(
		...
		'posts'       => array(
			'front' => array(
				...
				'post_title'   => esc_html_x( 'Homepage', 'Theme starter content', 'the8-shop-dark' ),
...
<!-- /wp:group -->',
            ...
            'about' => array(
                ...
                'post_type'    => 'page',
                'post_title'   => esc_html_x( 'About Us', 'Theme starter content', 'the8-shop-dark' ),
...
<!-- /wp:columns -->',
            ...
            'contact' => array(
                'post_type'    => 'page',
                'post_title'   => esc_html_x( 'Contact', 'Theme starter content', 'the8-shop-dark' ),
...
<!-- /wp:group -->',
		...
		'attachments' => array(
             'image-about-us' => array(
                    'post_title' => _x( 'About Us', 'Theme starter content', 'the8-shop-dark' ),
		...
		'nav_menus'   => array(
			...
			'menu-1' => array(
				'name'  => __( 'Main Menu', 'the8-shop-dark' ),
				'items' => array(
	...
	/**
	 * Filters the8-shop-dark array of starter content.
	 *
	 * @since the8-shop-dark 1.0.0
	 *
	 * @param array $starter_content Array of starter content.
	 */
	return apply_filters( 'the8_shop_dark_starter_content', $starter_content );
}
